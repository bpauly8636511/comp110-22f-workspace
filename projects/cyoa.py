...
def adventure_one() -> None:
    ...
    global POINTS
    global PLAYER
    print(f"1. Pet your Neko! {/U0001F63A}")
    print(f"2. Feed your Neko! {/U0001F638}")
    print(f"3. Play with your Neko! {/U0001F63C}")
    users_choice: int = input("Please choose a number 1 through 3 for one of the three options: ")
    while users_choice != 1 or 2 or 3:
        users_choice = input("Incorrect input! Please enter 1, 2 or 3: ")
    if users_choice == 1:
        POINTS += 20
        print(f"Congrats {PLAYER}! You have {POINTS} love points!")
    elif users_choice == 2:
...
def adventure_two(x: int) -> int:
    ...
    users_choice: int = input("Please choose option 1, 2, or three! ")
    global PLAYER
    while users_choice != 1 or 2 or 3:
        users_choice = input("Incorrect input! Please enter 1, 2, or 3! ")
    if users_choice == 1:
...
def game_loop() -> None:
    ...
    global POINTS
    while game_loop != 1 or 2 or 3:
        game_loop = input("Incorrect input! Please choose 1, 2, or 3!")
